            ...
            <div className="modal-box w-full max-w-5xl overflow ">
                ...
                >
                    <div className="w-full flex flex-row justify-between items-center z-10">
                        <h1 className="text-2xl font-bold text-green1 mb-2 mt-1">
                            {data?.title}
                        </h1>
                        <button
                            onClick={() => {
                    ...
                    <div className="w-full flex justify-between pr-5">
                        ...
                        <button
                            ...
                            className="py-1 px-2 rounded-sm bg-green1 text-white hover:bg-green1/90"
                        >
                            Hadir semua
                        </button>
                        <div className="flex flex-row gap-2 items-center mr-2">
                            <h1 className="text-sm font-bold bg-green1 text-white p-2 rounded-sm">
                                Hadir
                            </h1>
                    ...
                    <div className="w-25 flex flex-col gap-3 max-h-[20rem] overflow-y-auto overflow_type pr-5">
                        {data?.data?.map((item, index) => (
                            <div
                                key={index}
                                className="w-full p-2 border-b flex flex-row justify-between items-center"
                            >
                                <h1 className="w-40 text-sm font-bold flex items-center gap-2">
                    ...
                    <div className="flex flex-row justify-between items-center pr-5 gap-2">
                        ...
                        <div className="text-md flex flex-row gap-2">
                            <button
                                ...
                                className="py-2 px-3 rounded-sm bg-error text-white hover:bg-error/90"
                            >
                                Cancel
                            </button>{" "}
                            <button
                                type="submit"
                                className="py-2 px-3 rounded-sm  bg-green1 text-white hover:bg-green1/90"
                            >
                                Submit
                            </button>
                        </div>
