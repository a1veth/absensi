...
import TutupAbsensi from "@/Components/ui/modal/TutupAbsensi";
                ...
                <div className="w-full flex flex-row gap-5 bg-white shadow-lg rounded-md">
                    ...
                    <div className="flex flex-col gap-2 py-5 w-2/5">
                        ...
                        <p className="text-sm text-justify">
                            ...
                            Nasional. Silahkan membuka presensi kelas dan melakukan generate kode QR dengan
                            mengetuk ikon QR pada kelas hari ini untuk membuka
                            presensi.
                        </p>
                    </div>
                </div>
