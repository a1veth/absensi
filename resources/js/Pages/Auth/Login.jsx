...
export default function Login({ status, canResetPassword }) {
    ...
    return (
        <GuestLayout>
            ...
            <form
                onSubmit={submit}
                className="flex justify-center self-center z-10 shadow-md"
            >
                <div className="p-12 bg-white mx-auto rounded-2xl w-96">
                <div className="mb-3 flex flex-col items-center justify-center">
                <img
                    src={window.location.origin + "/logo_univ.png"}
                    alt=""
                    className="h-[6rem] w-[4.5rem] mb-3"
                />
                        <h1 className="mb-1 text-sm text-gray-800">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-col gap-4 items-center justify-between">
                            ...
                            <button
                                disabled={processing}
                                type="submit"
                                className="w-full flex justify-center bg-green1 hover:bg-green1/80 text-gray-100 p-3 rounded-lg tracking-wide font-semibold cursor-pointer transition ease-in duration-200"
                            >
                                Sign In
                            </button>
                        </div>
